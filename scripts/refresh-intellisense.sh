...
SKETCH_DIR="$CMAKE_BUILD_DIR/sketch/Ford-Mondeo-MK-DPF-Tracker"
...
source_map = {
    os.path.normpath(os.path.join(sketch_dir, "tracker.cpp")):
        os.path.normpath(os.path.join(project_dir, "tracker.cpp")),
}
real_source_map = {
